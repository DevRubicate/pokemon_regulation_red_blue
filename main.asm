...
INCLUDE "engine/reset_trainers.asm"
INCLUDE "customlogic/codeinput.asm"
...
INCLUDE "engine/menus/regulation_menu.asm"
INCLUDE "customlogic/regulations.asm"
INCLUDE "customlogic/title_screen.asm"
